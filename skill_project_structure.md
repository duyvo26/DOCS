...
*   [**Tiêu chuẩn Viết Code & Đặt tên (Coding Conventions)**](./skill_coding_conventions.md): Đặt tên, Type Hinting, Docstring, cấm emoji.
*   [**Git Workflow & Commit Convention**](./skill_git_workflow.md): Branch strategy, Conventional Commits, quy trình làm việc hàng ngày, cheat sheet lệnh Git.
...
9. **Khi vào chỉnh/sửa code, KIỂM TRA và THÊM DOCSTRING**: Nếu AI được yêu cầu sửa một file, trước khi chỉnh code PHẢI rà soát toàn bộ file:
...
10. **Khi người dùng yêu cầu "chuẩn hoá code"**: BẮT BUỘC phải:
